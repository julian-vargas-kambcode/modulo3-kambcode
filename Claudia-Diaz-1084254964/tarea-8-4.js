...
// Filtrar el estudiante con el promedio más alto
const estudiantePromedioMasAlto = estudiantes.filter(estudiante => estudiante.promedio === promedioMasAlto)[0];

// Imprimir en la consola el nombre y la edad del estudiante con el promedio más alto
console.log("El estudiante con el promedio más alto es:", estudiantePromedioMasAlto.nombre);
console.log("Su edad es:", estudiantePromedioMasAlto.edad);
...
const estudiantes = [
  ...
  console.log("Información completa de los estudiantes mayores de 20 años:");
